  ...
  <section id="utang-piutang-page" class="space-y-8 p-4 md:p-6"> <div class="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm group hover:border-rose-200 transition-colors">
            ...
            <p class="text-2xl font-black text-rose-600">Rp 5.000.000</p>
        </div>
        <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm group hover:border-indigo-200 transition-colors">
            ...
            <p class="text-2xl font-black text-indigo-600">Rp 2.000.000</p>
        </div>
        <div class="bg-indigo-50 p-6 rounded-2xl border border-indigo-100 shadow-sm">
            ...
            <p class="text-2xl font-black text-indigo-800">Rp 3.000.000</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="p-4 border border-slate-100 rounded-2xl hover:bg-slate-50 transition-all border-l-4 border-l-rose-500">
                    <div class="flex justify-between items-start mb-3">
                        <div>
                            ...
                            <p class="text-xs text-slate-500">Jatuh tempo: <span class="text-rose-500 font-medium">27 April 2026</span></p>
                        </div>
                        <span class="bg-rose-100 text-rose-600 text-[10px] px-2 py-1 rounded-full font-bold uppercase">Jatuh Tempo</span>
                    </div>
                    <div class="flex justify-between items-end">
                        <p class="text-xl font-black text-slate-800">Rp 250.000</p>
                        <div class="flex gap-2">
                            <button title="Kirim WA" class="p-2 text-emerald-600 bg-emerald-50 rounded-lg hover:bg-emerald-600 hover:text-white transition"><i class="fa-brands fa-whatsapp"></i></button>
                            <button title="Detail" class="p-2 text-slate-400 bg-slate-100 rounded-lg hover:bg-slate-200 transition"><i class="fa-solid fa-magnifying-glass text-xs"></i></button>
                            <button class="px-3 py-1.5 bg-indigo-600 text-white rounded-lg text-xs font-bold hover:bg-indigo-700 transition">Tandai Lunas</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm">
            ...
            <div class="p-4 space-y-4 text-center py-12">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-100">
                    <tr class="hover:bg-slate-50 transition">
                        <td class="p-4 text-xs text-slate-500">25 Apr 2026</td>
                        <td class="p-4 text-sm font-bold text-slate-700">Andi Wijaya</td>
                        <td class="p-4 text-xs text-slate-500 font-medium">Piutang</td>
                        <td class="p-4 text-center">
                            <span class="bg-emerald-100 text-emerald-600 text-[10px] px-2 py-1 rounded-full font-black uppercase">Lunas</span>
                        </td>
                        <td class="p-4 text-sm font-black text-right text-slate-800">Rp 100.000</td>
                    </tr>
                </tbody>
            </table>
        </div>
