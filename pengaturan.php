   ...
   <section id="pengaturan-page" class="space-y-6">
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="w-full lg:w-72 space-y-2">
            <button class="w-full text-left px-5 py-4 bg-indigo-600 text-white rounded-2xl font-bold text-sm flex items-center gap-3 shadow-lg shadow-indigo-100 transition-all">
                <i class="fa-solid fa-store w-5"></i> Profil & Struk
            </button>
            ...
            <button class="w-full text-left px-5 py-4 text-slate-500 hover:bg-slate-50 rounded-2xl font-bold text-sm flex items-center gap-3 transition">
                <i class="fa-solid fa-shield-halved w-5"></i> Keamanan & Data
            </button>
        </div>
        ...
        <div class="flex-1 space-y-8">
            ...
            <div class="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm">
                <div class="p-6 border-b border-slate-100 bg-slate-50/50">
                    <h3 class="font-bold text-slate-800 text-rose-600">Keamanan & Data</h3>
                </div>
                <div class="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm">
    ...
    <div class="p-8 space-y-8">
        ...
        <div class="flex items-center justify-between pb-8 border-b border-slate-50">
            <div>
                <h4 class="text-sm font-bold text-slate-800">PIN Keamanan</h4>
                <p class="text-xs text-slate-400">Minta PIN setiap kali menghapus transaksi atau stok.</p>
            </div>
        ...
        <div class="space-y-4">
            <h4 class="text-sm font-bold text-slate-800">Cadangkan Data (Backup)</h4>
            <p class="text-xs text-slate-400 mb-4">Simpan salinan data transaksi kamu secara offline.</p>
            <div class="flex flex-wrap gap-3">
                <button class="px-5 py-2.5 bg-slate-100 text-slate-600 rounded-xl text-[10px] font-bold hover:bg-slate-200 transition flex items-center gap-2 border border-slate-200">
                    <i class="fa-solid fa-code"></i> BACKUP JSON
                </button>
                <button class="px-5 py-2.5 bg-slate-100 text-slate-600 rounded-xl text-[10px] font-bold hover:bg-slate-200 transition flex items-center gap-2 border border-slate-200">
        ...
        <div class="pt-6 border-t border-rose-50 flex items-center justify-between">
            <div>
                <p class="text-sm font-bold text-rose-600">Hapus Seluruh Data</p>
                <p class="text-[10px] text-slate-400">Semua riwayat transaksi dan produk akan hilang permanen.</p>
            </div>
            <button class="px-4 py-2 bg-rose-50 text-rose-600 border border-rose-100 rounded-xl text-[10px] font-black hover:bg-rose-600 hover:text-white transition">RESET</button>
        </div>
    </div>
</div>
        </div>
